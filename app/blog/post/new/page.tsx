...
export default function NewPost() {
    ...
    return (
        <main>
            <div className={'p-14 m-4 max-sm:p-0 max-sm:m-0 max-sm:mt-20 [&_[role="alert"]]:text-red-500'}>
                <form onSubmit={handleSubmit((data) => {
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({field}) => (
                            <TagInputField disabled={disabled}  onChange={(content) => field.onChange(content)}/>
                        )}
                    />
                    <Controller
                        name="content"
